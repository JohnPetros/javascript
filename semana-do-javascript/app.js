...
const moviesReleasedBefore2000v1 = tarantinoMovies.filter(movie => movie.release < 2000)

// ou:

const moviesReleasedBefore2000v2 = tarantinoMovies.filter(({ release }) => release < 2000)

console.log(moviesReleasedBefore2000v1)

console.log(moviesReleasedBefore2000v2)
...
const gameListv2 = cart
.reduce((accumulator, { name }) => `${accumulator}- ${name}\n`, '')

console.log(gameListv2)